...
class PostgresDataBase(DataManager):
    """Class providing "insert" and "clean" methods that deletes or adds data to a postgres data base"""
    ...
    def insert(self, price, date, ema_long, ema_short, macd, rsi, adx):
        """Method inserting data into a postgres data base"""
    ...
    def clean(self):
        """Method erasing data into a postgres data base"""
